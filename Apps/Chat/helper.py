...
class TestAPIHelper:
    ...
    def _setUp(self, Production=False, API_Name='', URL='', URL_Not_Found='', Host='') -> None:
        ...
        self._Host = Host if Production else 'http://127.0.0.1:8000'
        
        self._url = self._Host + URL
        self._url_not_found = self._Host + URL_Not_Found
        self.__Token_Url = self._Host + reverse('Auth.api:Token')
...
class GetRoomNotFound:
    ...
    def test_room_not_found(self):
        ...
        self.assertTrue(_response.status_code == 404, self._Message('Get Room Does Not Exists'))


class PatchRoomNotFound:

    def test_patch_room_not_found(self):
        ...
        self.assertTrue(_response.status_code == 404, self._Message('Patch Room Does Not Exists'))


class DeleteRoomNotFound:
    ...
    def test_delete_room_not_found(self):
        ...
        self.assertTrue(_response.status_code == 404, self._Message('Delete Room Does Not Exists'))
