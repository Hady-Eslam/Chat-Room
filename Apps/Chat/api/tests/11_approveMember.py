...
class TestAPI(
    ...
    def test_approve_creator(self):
        ...
        self.assertTrue(_response.status_code == 200, self._Message('Approve Creator'))
    ...
    def test_approve_member(self):
        ...
        self.assertTrue(_response.status_code == 200, self._Message('Approve Member'))
