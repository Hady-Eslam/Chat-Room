...
class TestAPI(
    ...
    def test_kickout_creator(self):
        ...
        self.assertTrue(_response.status_code == 403, self._Message('Kick Out Creator'))
    

    def test_kickout_member(self):
        ...
        self.assertTrue(_response.status_code == 204, self._Message('Kick Out Member'))
